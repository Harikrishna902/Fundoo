    ...
    <div class="panel-body">
     <form method="post" ng-submit="submitLogin()">
      <div class="form-group">
       <label style="color:crimson">Enter Your Email</label>
       <input type="text" name="email" ng-model="loginData.email" class="form-control" />
      </div>
      <div class="form-group">
       <label style="color:crimson">Enter Your Password</label>
   ...
   <div class="panel panel-default" ng-show="register_form">
    ...
    <div class="panel-body">
     <form method="post" ng-submit="submitRegister()">
      <div class="form-group">
       <label style="color:green">Enter first Name</label>
       <input type="text" name="name" ng-model="registerData.name" required placeholder="First Name" class="form-control" />
      </div>
      <div class="form-group">
       <label style="color:green">Enter Last Name</label>
       <input type="text" name="name" ng-model="registerData.name" required placeholder="Last Name"class="form-control" />
      </div>
      <div class="form-group">
       <label style="color:green">Enter Your Email</label>
       <input type="text" name="email" ng-model="registerData.email" required placeholder="Email" class="form-control" />
      </div>
      <div class="form-group">
       <label style="color:green">Enter Your Password</label>
       <input type="password" name="password" ng-model="registerData.password"  required placeholder="Password"class="form-control" />
      </div>
      <div class="form-group">
       <label style="color:green">confirm Password</label>
       <input type="password" name="password" ng-model="registerData.password" required placeholder="Confirm password" class="form-control" />
      </div>
      <div class="form-group" align="center">
